...
@ServerEndpoint(value = "/websocket/apollo/{params}")
@Component
public class WebSocketApollo {
	...
	public void setHostMapper(HostMapper hostMapper) {
		WebSocketApollo.hostMapper = hostMapper;
	}
	...
	private static CopyOnWriteArraySet<WebSocketApollo> webSocketSSHServerSet = new CopyOnWriteArraySet<WebSocketApollo>();
	...
	public void onOpen(Session websocketSession, @PathParam("params") String params) {
		...
		if (StringUtils.isNotEmpty(hostIp)) {
			...
			case "install":
				...
				this.client.write("sh addons.sh install apollo\r");
				break;
			case "uninstall":
				this.client.write("cd yusp-autoinstall/yusp-autoinstall-shell\r");
				this.client.write("sh addons.sh uninstall apollo\r");
				break;
			case "start":
				this.client.write("service apollo start\r");
				break;
			case "stop":
				this.client.write("service apollo stop\r");
				break;
			case "status":
				this.client.write("service apollo status\r");
				break;
			default:
				break;
			}
