...
@ServerEndpoint(value="/websocket/status/{params}")
@Component
public class WebSocketStatusService {
	
	private static Log logger = LogFactory.getLog(WebSocketStatusService.class);
	...
	public void setHostMapper(HostMapper hostMapper) {
		WebSocketStatusService.hostMapper = hostMapper;
	}
    ...
    private static CopyOnWriteArraySet<WebSocketStatusService> webSocketSSHServerSet = new CopyOnWriteArraySet<WebSocketStatusService>();
    ...
    public void onOpen(Session websocketSession,@PathParam("params") String params) {
    	...
    	if (StringUtils.isNotEmpty(hostIp)) {
            ...
            this.client.write("chmod 777 YUSP\r");
    ...
    public static synchronized void addOnlineCount() {
    	WebSocketStatusService.onlineCount++;
    }
