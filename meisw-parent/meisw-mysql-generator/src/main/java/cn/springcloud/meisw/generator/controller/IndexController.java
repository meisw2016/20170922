package cn.springcloud.meisw.generator.controller;
...
import cn.springcloud.meisw.generator.entity.ReturnT;
import cn.springcloud.meisw.generator.util.CodeGeneratorTool;
import cn.springcloud.meisw.generator.util.FreemarkerTool;
...
public class IndexController {
	...
	@ResponseBody
	public OutputData codeGenerate(
	        String tableSql,
	        // 2019-2-10 liutf 修改为@RequestParam参数校验
	        @RequestParam(required = false, defaultValue = "meisw") String authorName,
	        @RequestParam(required = false, defaultValue = "com.softdev.system") String packageName,
	        @RequestParam(required = false, defaultValue = "OutputData") String outputData,
