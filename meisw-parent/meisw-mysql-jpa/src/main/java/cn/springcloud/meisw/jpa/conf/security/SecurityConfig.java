...
import cn.springcloud.meisw.jpa.conf.security.filter.AdminAuthenticationProcessingFilter;
import cn.springcloud.meisw.jpa.conf.security.filter.MyAuthenticationFilter;
import cn.springcloud.meisw.jpa.conf.security.login.AdminAuthenticationEntryPoint;
import cn.springcloud.meisw.jpa.conf.security.url.UrlAccessDecisionManager;
import cn.springcloud.meisw.jpa.conf.security.url.UrlAccessDeniedHandler;
import cn.springcloud.meisw.jpa.conf.security.url.UrlFilterInvocationSecurityMetadataSource;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/**
	 * 忽略拦截url或静态资源文件夹 - web.ignoring(): 会直接过滤该url - 将不会经过Spring Security过滤器链 http.permitAll(): 不会绕开springsecurity验证，相当于是允许该路径通过
	 * @param web
	 * @throws Exception
	 */
	@Override
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers(HttpMethod.GET, "/favicon.ico", "/**/*.png", "/**/*.ttf", "/*.html", "/**/*.css",
		        "/**/*.js");
	}
